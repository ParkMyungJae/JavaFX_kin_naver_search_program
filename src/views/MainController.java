...
public class MainController {
	...
	private String ci = "pyomRbvLnCB1QxDWS_7b";
	private String cs = "fne5AcnBoW";
	private String apiURL = "https://openapi.naver.com/v1/search/kin.json";
	...
	public void search() {
		...
		try {
			...
			URL urlIns = new URL(apiURL + "?query=" + word);
